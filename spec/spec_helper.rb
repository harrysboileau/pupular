...
RSpec.configure do |config|
  include SignInSignUpSpecHelper
  include DoghouseSpecHelper
  include MessageSpecHelper
  include NewEventSpecHelper
  include QRSpecHelper
  include OtherDogProfileSpecHelper
  include UsersEventsSpecHelper
